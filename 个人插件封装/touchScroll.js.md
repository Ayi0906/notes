```javascript
/*
 * 依赖:transformCSS.js,tweenAnimation.js
 */
...
;
(function (w) {
    function TocuScroll(container, wrapper, options) {
        ...
        oContainer.addEventListener('touchend', function (e) {
            ...
            // wrapper的translateY值与滚动条的translateY值是一个固定的比值
            ...
            tweenAnimation(oWrapper, 'translateY', disY, top, 500, 60, type)
            tweenAnimation(oScrollBar, 'translateY', scrollBarY, scrollBarTop, 500, 60, type)
        }, false)
...
- 我去掉了tweenAnimation.js函数的帧数设置，并新加了回调函数的设置
- 修改了函数名
